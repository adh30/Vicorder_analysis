function params = estimate_Zc_C_gamma(SBP, DBP, MAP, HR, SV_ref)
% Estimate Zc, C, gamma from SBP, DBP, MAP, HR and reference SV
%
% Model:
%   SV = 0.5 * Ts * [ PP/Zc + C * (PP/(gamma*Ts)) ]

% -----------------------------
% Prepare data
% -----------------------------
PP = SBP - DBP;
Ts = 0.406 - 0.0017 .* HR;   % Weissler-type systolic duration
